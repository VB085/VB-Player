...
a = Analysis(
    ...
    hiddenimports=['PyQt6.QtMultimedia', 'mutagen', 'mutagen.mp3', 'mutagen.flac', 'mutagen.oggopus', 'mutagen.oggvorbis', 'mutagen.mp4', 'mutagen.id3', 'mutagen.aac', 'numpy', 'qtawesome', 'PIL', 'PIL.Image', 'PIL.ImageDraw', 'io.BytesIO', 'audio_player.platform.linux.bluetooth', 'audio_player.platform.linux.audio_devices', 'PyQt6.QtDBus'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
